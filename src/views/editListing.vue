<template>
  <div class="editlisting">
      <b-container>
             <b-form @submit.prevent="updateListing()">

            
             <b-row>
                <b-col>
                  <b-form-group label="Bussiness Owner Name :"> 
                      <b-form-input  :state="ownerNameValidation" type="text" class="bg-light" v-model="listing.ownerName" placeholder="Owner Name"></b-form-input> 
              ...
              <b-row>
                <b-col>
                  <b-form-group label="Bussiness Title :"  :invalid-feedback="bussinessNameinvalidFeedback" :valid-feedback="bussinessNamevalidFeedback" :state="bussinessNamestate"> 
                      <b-form-input  type="text" class="bg-light " :state="bussinessNamestate" v-model="listing.bussinessName" placeholder="Bussiness Name"></b-form-input> 
                  </b-form-group>
                </b-col>
              </b-row>
              <b-row>
                <b-col>
                  <b-form-group label="Bussiness Category :"> 
                       <b-form-select v-model="listing.bussinessCategory" :options="categories" required></b-form-select>
                  </b-form-group>
                </b-col>
              </b-row>
              <b-row>
                <b-col>
                  <b-form-group label="Bussiness Phone:"> 
                      ...
                      <VuePhoneNumberInput v-model="listing.bussinessPhone" error-color="red"/>
                  </b-form-group>
                </b-col>
                <b-col>
                  <b-form-group label="Area Code:"> 
                      <b-form-input  :state="areaCodeValidation" type="number" class="bg-light" v-model="listing.areaCode" placeholder="Area Code"></b-form-input> 
              ...
              <b-row>
                <b-col>
                  <b-form-group label="Bussiness Email :"> 
                      <b-form-input  :state="emailValidation" type="text" class="bg-light" v-model="listing.bussinessEmail" placeholder="Bussiness Email"></b-form-input> 
              ...
              <b-row>
                <b-col>
                  <b-form-group label="Bussiness Address :"> 
                      <b-form-input  type="text" class="bg-light " v-model="listing.address1" placeholder="Address - 1"></b-form-input>
                      <b-form-input  type="text" class="bg-light " v-model="listing.address2" placeholder="Address - 2"></b-form-input>
                      <b-form-select v-model="listing.city" :options="bussinessAddress.city" required></b-form-select>          
                  </b-form-group>
                </b-col>
              </b-row>
               <b-row>
                <b-col>
                  <b-form-group label="Bussiness Description :"> 
                      <vue-editor v-model="listing.bussinessDescription"/>
                  </b-form-group>
                </b-col>
              </b-row>
              <b-row>
              ...
              <b-row>
                <b-col>
                  <b-form-group label="Upload Image :"> 
                       ...
                       <b-progress :value="progressvalue" max="100" show-progress animated class="mt-3"></b-progress>
                  </b-form-group>
                </b-col>
              </b-row>
              ...
              <b-row class="">
                <b-col sm="12">
                   <b-button variant="primary" type="submit">Update Listing</b-button>
                </b-col>
              </b-row>
              </b-form> 
           </b-container>
...
export default {
    ...
    computed: {
            listing(){
                const l = this.listings.filter(x => x.id == this.listingID)
                return l[0];
            },
            bussinessNamestate(){
       ...
       methods:{
        ...
        updateListing()
        {
            ...
            {
                 this.listing.imageUrl = this.file;
            }   
            this.$firestore.listings.doc(this.listingID).update(this.listing)
            Toast.fire({
